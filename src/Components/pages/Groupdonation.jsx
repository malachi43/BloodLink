    ...
    <div>
      ...
      >
        <div className="text-center text-white space-y-4 mb-[8em]">
          ...
          <button
            className={`bg-[#008000] hover:bg-[#008000e1] text-white p-3 rounded-lg`}
          >
            Get Started
          </button>
        </div>
      ...
      <div className={`p-10`}>
        <p className="text-2xl text-center text-[#404040] font-bold">
          Donate blood
        </p>
      </div>
      ...
      >
        ...
        <div className="text-center space-y-6">
          ...
          <button
            className={`bg-[#008000] hover:bg-[#008000e1] text-white p-3 rounded-lg w-[100%]`}
          >
            Start Now
          </button>
        </div>
      ...
      <div className={`border-solid border-2 border-[#40404068] md:mx-20 mt-4 mb-6`}>
        ...
        <div className={`md:flex justify-around p-4`}>
          <div className="space-y-4">
            ...
            >
              <p>What are the eligibility requirements for donating blood?</p>
            </div>
            <div
              className={`border-solid border-2 border-[#40404037] rounded-md p-4`}
            >
              <p>Why is there a need for blood donations?</p>
            </div>
            <div
              className={`border-solid border-2 border-[#40404037] rounded-md p-4`}
            >
            ...
            <div
              className={`border-solid border-2 border-[#40404037] rounded-md p-4`}
            >
              <p>What can I expect during the donation process?</p>
            </div>
            <div
              className={`border-solid border-2 border-[#40404037] rounded-md p-4`}
            >
              <p>What should I do after donating blood?</p>
            </div>
            <div
              className={`border-solid border-2 border-[#40404037] rounded-md p-4`}
            >
              <p>Are there any side effects to donating blood?</p>
            </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-center text-2xl">Ask a Question</p>
            <input
              type="text"
              placeholder="Enter a question"
              className={`border-solid border-2 border-[#40404037] rounded-md p-2`}
            />
            <button
              className={`bg-[#008000] hover:bg-[#008000e1] text-white p-3 rounded-lg`}
            >
