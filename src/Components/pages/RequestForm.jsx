...
let RequestForm = () => {
    return (
        <div className="mx-10">
            ...
            <Link reloadDocument to="/receive-blood#requestForBlood"><div className="place-self-center"><button className="p-4 bg-[#008000] rounded-lg text-white">Submit Request</button></div></Link>
        </div>
    )
}
